...
describe('Algoritma Aho_Corasick (AC)', () => {
    ...
    it('menangani string kosong dan array keyword kosong dengan aman', () => {
        expect(ahoCorasickSearch([], "Beberapa teks")).toEqual([]);
        expect(ahoCorasickSearch(["slot"], "")).toEqual([]);
        expect(ahoCorasickSearch([], "")).toEqual([]);
    });
